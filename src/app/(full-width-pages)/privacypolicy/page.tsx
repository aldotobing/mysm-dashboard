...
export const metadata: Metadata = {
  title: "Privacy Policy | Next.js Admin Dashboard",
  description: "Privacy Policy for the Admin Dashboard",
};
            ...
            <div className="px-4 py-5 sm:p-6">
              <div className="prose prose-lg max-w-none dark:prose-invert">
                ...
                <ul className="list-disc pl-5 space-y-2">
                  ...
                  <li>
                    <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Nextbasis E-commerce.
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Website</strong> refers to Nextbasis E-commerce Admin Dashboard, accessible from <a href="#" className="text-blue-600 hover:underline">https://admin.nextbasis.com</a>
                  </li>
                  <li>
                ...
                <ul className="list-disc pl-5 space-y-2">
                  <li>By email: privacy@nextbasis.com</li>
                  <li>By phone: +62 123 4567 890</li>
                  <li>By mail: Jl. Example No. 123, Jakarta, Indonesia</li>
                </ul>
              </div>
            </div>
          </div>
